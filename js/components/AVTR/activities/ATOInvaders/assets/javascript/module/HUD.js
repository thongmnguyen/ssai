...
define(function() {
	...
	return {
		...
		createStat: function(score, health, lives) {
			_score = score;
			_scoreText = _game.add.text(10, 10, "Score: " + score, {
				fontSize: "34px",
				fill: "#fff"
			});
			_health = health;
			_healthText = _game.add.text(10, 50, "Health: " + health, {
				fontSize: "34px",
				fill: "#fff"
			});
			_lives = lives;
			_livesText = _game.add.text(10, 90, "Lives: " + lives, {
				fontSize: "34px",
				fill: "#fff"
			});
